    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('MANAGEMENT', 'مدیریت'), ('ADMINISTRATIVE', 'اداری'), ('WORKERS', 'کارگران')], default='WORKERS', max_length=20, verbose_name='دپارتمان')),
                ('role', models.CharField(choices=[('USER', 'کاربر'), ('GUARD', 'نگهبان'), ('MANAGER', 'مدیر')], default='USER', max_length=10, verbose_name='نقش')),
